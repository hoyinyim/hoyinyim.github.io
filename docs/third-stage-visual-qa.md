...
- 快取修正合併提交 `aad228e0` 部署成功後，已在 `https://hoyinyim.github.io/` 實際複驗：HTML 引用 `site.js?v=20260719-3` 與 `third-stage.css?v=20260719-3`；Menu 唯一標示首頁、焦點移至 CLOSE、沒有水平溢位；研討會兩筆指定連結各一筆；證照與獎項兩個典藏預覽均已初始化。
